export function initCursor() {
    ...
    // Always attach listener to ensure cursor works even if media query fails or is borderline
    // The CSS * { cursor: none } hides the default cursor, so we MUST show ours.
